...
const searchRepo = async (m, Matrix) => {
  ...
  if (validCommands.includes(cmd)) {
    const repoUrl = `https://api.github.com/repos/Betingrich3/Mercedes`;
...
*_Owner:_* *Marisel*
*_Session_* https://shorturl.at/SJBuI
*_Tutorials_* https://shorturl.at/h45nS
    `;
          ...
          interactiveMessage: proto.Message.InteractiveMessage.create({
            ...
            header: proto.Message.InteractiveMessage.Header.create({
              ...(await prepareWAMessageMedia({
                image: {
                  url: 'https://files.catbox.moe/z4t2jc.jpg',
                },
              ...
              buttons: [
                {
                  ...
                  buttonParamsJson: JSON.stringify({
                    ...
                    url: 'https://wa.me/+254740007567?text=Hi Marisel',
                  }),
                },
                {
                  name: 'cta_url',
                  buttonParamsJson: JSON.stringify({
                    ...
                    url: 'https://github.com/betingrich3/Mercedes/fork',
                  }),
                },
                {
                  name: 'cta_url',
